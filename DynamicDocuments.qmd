...
The P value is far below 0.025 (two tailed test) so we can reject the null hypothesis. There is a significant difference between beak depths in 1976 and 1978.

# conclusion

This shows that the data is consistent with natural selection of beak depth in response to drought. This data suggests that individuals with smaller beaks were selected against, and the distribution shifted towards larger beaks.

This analysis demostrates the suprising speed at which natural selection can occur, within just years a significant, measureable change in phenotype had occurred. This
