...
![Figure 3: Diagnostic plots for the Linear model](Figures/Diagnostic Plots.svg){width="601" height="340"}
...
LmPlot <- BoxGraph(Data, Data$Depth, "Beak Depth (mm)",
                   Data$Year, "Year" , "Model Plot", TRUE) SaveSVG(LmPlot, here("Figures", "Linear Model Plot.svg"), 5, 7, 1.2)
```
